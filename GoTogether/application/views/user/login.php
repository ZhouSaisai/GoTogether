    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="http://localhost/index.php/user/login">登录</a></li>
                <li><a href="http://localhost/index.php/user/register">注册</a></li>
            </ul>
        </div><!-- /.nav-collapse -->
    </div> <!-- /.container -->
</nav> <!-- /.navbar -->
    ...
    <div class="con-block container-1">
        ...
        <div class="container-login">
            ...
            <form action="askLogin"  method="post">
                ...
                <p class="login-info info1"><a href="#">忘记密码？</a> </p>
                <p class="login-info info">还没有账户？<a href="http://localhost/index.php/user/register">立即注册</a></p>
            </form>
        </div>
    </div>
